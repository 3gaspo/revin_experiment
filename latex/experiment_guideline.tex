...
artifact selection or staging. With a job ID, it commits only that job's exact
stdout/stderr pair. Omitting the job ID publishes all logs and lightweight
outputs, excluding \code{*.pt}, \code{*.npy}, and \code{*.cbm}. It then pushes
