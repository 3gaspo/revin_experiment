...
\textbf{Loss implementation:} \code{src/utils/losses.py}\\
...
seeds, with validation every 1,000 steps.  Final tables always use test MSE in
data space, show sample standard deviations, and state the row multiplier.
